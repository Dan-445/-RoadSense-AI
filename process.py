...
EXTRACTED_FRAMES_DIR = r"extracted_frame17"  # Directory where frames will be saved
PROCESSED_FRAMES_DIR = r"output33/processed_frames"  # Directory to save processed frames (with bounding boxes)
OUTPUT_CSV_PATH = r"output3/VRI_detection_data.csv"  # Path to save the CSV output
OUTPUT_EXCEL_PATH = r"output3/VRI_detection_data.xlsx"  # Path to save the Excel output
OUTPUT_VIDEO_PATH = r"output3/damaged_video.mp4"  # Path to save the MP4 video output
